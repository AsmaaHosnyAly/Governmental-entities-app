                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    <label for="inputCity">القسم</label>
                                    <select class="custom-select my-1 mr-sm-2" name="Specialization_id">
                                        <option value="{{$employees->Specialization_id}}">{{$employees->specializations->Name}}</option>
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="Gender_id">
                                        <option value="{{$employees->Gender_id}}">{{$employees->genders->Name}}</option>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">تاريخ الالتحاق</label>
                                    <div class='input-group date'>
                                        <input class="form-control" type="text"  id="datepicker-action"  value="{{$employees->Joining_Date}}" name="Joining_Date" data-date-format="yyyy-mm-dd"  required>
                                    </div>
                                    @error('Joining_Date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="Address"
                                          id="exampleFormControlTextarea1" rows="4">{{$employees->Address}}</textarea>
                                @error('Address')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
